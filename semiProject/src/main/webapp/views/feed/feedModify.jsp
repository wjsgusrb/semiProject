...
<body>
    ...
    <div class="outer">
        ...
        <div class="right-area">
            ...
            <div>
                <button class="btn btn-primary" style="margin-left: 30%; margin-top: 20px;">수정완료</button>
                <button class="btn btn-primary" style="margin-left: 30px; margin-top: 20px;">뒤로가기</button>
            </div>
